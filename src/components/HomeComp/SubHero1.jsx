...
const SubHero = () => {
    return (
        <div className='bg-[#efe6da] font-[Helvetica] flex justify-center h-[500px] items-center'>
            <div className="video w-1/2 flex justify-center items-center">
                <video className='w-[90%] h-[90%] border rounded-lg' autoPlay loop controls src="src/assets/Home 1 - AI Chat Bot - Google Chrome 2024-03-02 12-35-30.mp4"></video>
            </div>
            <div className="text w-1/2 text-2xl font-semibold font-[helvetica] px-5 flex flex-col justify-center items-center gap-8">
