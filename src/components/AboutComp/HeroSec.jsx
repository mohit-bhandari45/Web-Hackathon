...
const HeroSec = () => {
    return (
        <>
            <div className='h-[87vh] bg-[#efe6da] flex justify-between p-20 items-center'>
                <div className="text w-[100px] text-black text-9xl font-bold">
                    What We Do.
                </div>
                <div className="imgdet w-[55vw] bg-[#142726] h-[70vh] text-white text-[35px] p-10 rounded-xl font-semibold shadow-lg shadow-black">
